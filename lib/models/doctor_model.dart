...
class Results {
    ...
    Results({this.id, this.hisCity, this.hisSpecialty, this.hisGovernorate, this.hisPhoto, this.hisName, this.hisAge, this.hisSex, this.hisClinicName, this.hisClinicLocation, this.hisClinicNumber, this.hisClinicStartAt, this.hisClinicFinshAt, this.hisClinicPrice, this.hisEmailForConnect, this.hisNumberForConnect});
